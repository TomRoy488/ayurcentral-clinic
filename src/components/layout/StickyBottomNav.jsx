...
function StickyBottomNav() {
  return (
    <nav className="ayurAptayu-bottomNav" aria-label="Primary">
      <div className="ayurAptayu-bottomNavInner">
        <NavLink to="/" end className={({ isActive }) => `ayurAptayu-bottomNavItem ${isActive ? 'is-active' : ''}`}>
        ...
        <NavLink to="/treatment" className={({ isActive }) => `ayurAptayu-bottomNavItem ${isActive ? 'is-active' : ''}`}>
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <a
          className="ayurAptayu-bottomNavItem"
          href="https://www.ayurcentralonline.com/"
          target="_blank"
          rel="noreferrer"
        ...
        >
          ...
          <span> 
            <span className='ayurAptayu-bottomNavItemTextIcon'>
              <svg
